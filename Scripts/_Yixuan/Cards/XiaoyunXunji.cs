...
namespace Miyabists2.Scripts._Yixuan.Cards
{
    ...
    {
        public XiaoyunXunji() : base(1, CardRarity.Common, TargetType.AnyEnemy,CardType.Skill)
        {
        }

        protected override string ArtPath => "res://images/_YiXuan/cards/xiaoyunXunji.png";
