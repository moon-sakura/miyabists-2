...
namespace Miyabists2.Scripts._Yixuan.Cards
{
    ...
    internal class FufaQianchongPo : YixuanAtkCardBase
    {
        public FufaQianchongPo() : base(0, CardRarity.Token, TargetType.AllEnemies)
        {
        }

        protected override string ArtPath => "res://images/_YiXuan/cards/fufaQianchongPo.png";
        ...
        protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
        {
            ...
            {
                await PowerCmd.Apply<ShufaZhi>(choiceContext, enemy, 20, Owner.Creature, this);
            }
        }
